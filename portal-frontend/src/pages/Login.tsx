...
export default function Login() {
  ...
  async function handleLogin() {
    ...
    if (!password)        { setError(t('login.errorNoPassword')); return }
    ...
    try {
      ...
      if (e.status === 429) setError(e.message || t('login.errorRateLimit'))
      else setError(e.message || t('login.errorInvalid'))
    }
    setLoading(false)
  }
